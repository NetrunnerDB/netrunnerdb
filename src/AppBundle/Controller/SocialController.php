...
class SocialController extends Controller
{
    ...
    public function donatorsAction(EntityManagerInterface $entityManager)
    {
        ...
        $users = $dbh->executeQuery("SELECT * FROM user WHERE donation > 0 OR patreon_pledge_cents > 0 ORDER BY (donation + patreon_pledge_cents) DESC, username", [])->fetchAll(\PDO::FETCH_ASSOC);
