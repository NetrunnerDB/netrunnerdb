...
class ReviewController extends Controller
{
    public function postAction(Request $request)
    {
        ...
        $review = $em->getRepository('NetrunnerdbBuilderBundle:Review')->findOneBy(array('card' => $card, 'user' => $user));
        if($review) {
    ...
    public function editAction(Request $request)
    {
        ...
        /* @var $review Review */
        $review = $em->getRepository('NetrunnerdbBuilderBundle:Review')->find($review_id);
        if(!$review) {
    ...
    public function likeAction(Request $request)
    {
        ...
        if($review->getUser()->getId() != $user->getId())
        {
            ...
            $query = $em->getRepository('NetrunnerdbBuilderBundle:Review')
    ...
    public function listAction($page = 1, Request $request)
    {
        ...
        $dql = "SELECT r FROM NetrunnerdbBuilderBundle:Review r JOIN r.card c JOIN c.pack p WHERE p.dateRelease IS NOT NULL ORDER BY r.dateCreation DESC";
        ...
        return $this->render('NetrunnerdbBuilderBundle:Reviews:reviews.html.twig',
                array(
                        'pagetitle' => $pagetitle,
    ...
    public function byauthorAction($user_id, $page = 1, Request $request)
    {
        ...
        $dql = "SELECT r FROM NetrunnerdbBuilderBundle:Review r WHERE r.user = :user ORDER BY r.dateCreation DESC";
