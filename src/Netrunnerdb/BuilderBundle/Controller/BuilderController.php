...
class BuilderController extends Controller
{
    ...
    public function initbuildAction ($card_code)
    {
		...
		$active_mwl = $em->getRepository('NetrunnerdbBuilderBundle:Mwl')->findOneBy(array('active' => TRUE));
    ...
    public function editAction ($deck_id)
    {
        ...
        $list_mwl = $this->getDoctrine()->getManager()->getRepository('NetrunnerdbBuilderBundle:Mwl')->findBy(array(), array('dateStart' => 'DESC'));
